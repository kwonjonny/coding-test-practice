...
public class 접미사인지_확인하기 {
    public static void main(String[] args) {
        ...
        int answer = solution(str, suffix);
        System.out.println(answer);
    }
    public static int solution(String str, String suffix) {
        int answer = 0;
        for(int i = 0; i < str.length(); i++) {
            String myString = str.substring(i, str.length());
            if(myString.equals(suffix)) return 1;
        }
        return answer;
    }
}
