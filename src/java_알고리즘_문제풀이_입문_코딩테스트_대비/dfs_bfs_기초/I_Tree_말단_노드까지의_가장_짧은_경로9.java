...
public class I_Tree_말단_노드까지의_가장_짧은_경로9 {
     ...
     * 재 복습: 2025-06-07
     */
    public static class I_Tree_말단_노드까지의_가장_짧은_경로9_8 {
        public static void main(String[] args) {
            I_Tree_말단_노드까지의_가장_짧은_경로9_8 T = new I_Tree_말단_노드까지의_가장_짧은_경로9_8();
            T.root = new Node(1);
    ...
    public static class I_Tree_말단_노드까지의_가장_짧은_경로9_6 {
        public static void main(String[] args) {
            I_Tree_말단_노드까지의_가장_짧은_경로9_6 T = new I_Tree_말단_노드까지의_가장_짧은_경로9_6();
            T.root = new Node(1);
            T.root.lt = new Node(2);
            T.root.rt = new Node(3);
            T.root.lt.lt = new Node(4);
