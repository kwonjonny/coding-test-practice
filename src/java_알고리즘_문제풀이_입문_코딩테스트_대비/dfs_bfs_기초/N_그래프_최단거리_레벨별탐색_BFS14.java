...
public class N_그래프_최단거리_레벨별탐색_BFS14 {
     ...
     * 재 복습: 2025-05-23
     */
    public static class N_그래프_최단거리_레벨별탐색_BFS14_7 {
        static int N;
        static int T;
        static int[] distance;
        static int[] check;
     ...
     * 재 복습: 2025-05-22
     */
    public static class N_그래프_최단거리_레벨별탐색BFS14_6 {
        static int N;
        static int T;
        static List<List<Integer>> graph;
        static int[] check;
     ...
     * 재 복습:2025-05-21
     */
    public static class N_그래프_최단거리_레벨별탐색BFS14_5 {
        public static void main(String[] args) {
            Scanner scan = new Scanner(System.in);
            N = scan.nextInt();
            T = scan.nextInt();
     ...
     * 재 복습: 2025-03-16
     */
    public static class N_그래프_최단거리_레벨별탐색_BFS14_4 {
        static int N;
        static int T;
        static int[] check;
        static List<List<Integer>> graph;
