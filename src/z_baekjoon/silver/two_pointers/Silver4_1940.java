 ...
 *
 * 야철대장은 자신이 만들고 있는 재료를 가지고 갑옷을 몇 개나 만들 수 있는지 궁금해졌다. 이러한 궁금증을 풀어 주기 위하여 N(1 ≤ N ≤ 15,000) 개의 재료와 M이 주어졌을 때 몇 개의 갑옷을 만들 수 있는지를
 *
 * 구하는 프로그램을 작성하시오.
 *
 * 입력
...
public class Silver4_1940 {
     ...
     * 재 복습: 2025-01-07
     */
    public static class Silver4_1940_1 {
        public static void main(String[] args) {
            Silver4_1940_1 silver419401 = new Silver4_1940_1();
            Scanner scan = new Scanner(System.in);
            Integer length = scan.nextInt();
            ...
            silver419401.solution(length, sumOrder, intArray);
        }
        public void solution(Integer length, Integer sumOrder, Integer[] intArray) {
            ...
            while(right > left) {
                ...
                if(sumOrder.equals(sum)) {
                    answer++;
                    right--;
                    left++;
                } else if (sum > sumOrder) {
                    right--;
                } else {
                    left++;
                }
