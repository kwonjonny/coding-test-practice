...
public class B1_Array {
    ...
    public static class B1Array12 {
        public static void main(String[] args) {
            ...
            B1Array12.solution(length, intArray);
        }
    ...
    public static class B1Array11 {
        public static void main(String[] args) {
            ...
            B1Array11.solution(length, intArray);
        }
        public static void solution(Integer length, Integer[][] intArray) {
            int[] dx = {-1, 0, 1, 0};
            int[] dy = {0, 1, 0, -1};
    ...
    public static class B1Array10 {
        public static void main(String[] args) {
            ...
            B1Array10.solution(length, intArray);
        }
        public static void solution(Integer length, Integer[][] intArray) {
            int[] nx = {-1, 0, 1, 0};
            int[] ny = {0, 1, 0, -1};
    ...
    public static class B1Array8 {
        public static void main(String[] args) {
            B1Array8 b1Array8 = new B1Array8();
            Scanner scan = new Scanner(System.in);
            Integer length = scan.nextInt();
            Integer[][] intArray = new Integer[length][length];
            for(int i = 0; i < length; i++) {
            ...
            b1Array8.solution(length, intArray);
        }
        public void solution(Integer length, Integer[][] intArray) {
            int[] nx = {-1, 0, 1, 0};
            int[] ny = {0, 1, 0, -1};
